...
function renderHome() {
    mainContainer.innerHTML = `
        <section class="hero" style="background-image: linear-gradient(135deg, rgba(0, 31, 63, 0.85) 0%, rgba(0, 51, 102, 0.75) 30%, rgba(0, 105, 148, 0.7) 70%, rgba(64, 153, 199, 0.8) 100%), url('assets/images/hero/hero-bg.png'); background-size: cover; background-position: center;">
